...
cm_socket_recv(unsigned argc, obj_t args)
{
  ...
  m_string_newc(consts.cl.string, 1, rc, STRING(R0)->data);
}
...
socket_module_init(void)
{
  ...
  m_integer_new(consts.cl.integer, AF_INET);
  m_method_call_3(consts.str.defc_putc, consts.cl.env, socket_consts.str.af_inet, R0);
  m_integer_new(consts.cl.integer, SOCK_DGRAM);
  m_method_call_3(consts.str.defc_putc, consts.cl.env, socket_consts.str.sock_dgram, R0);
  m_integer_new(consts.cl.integer, SOCK_STREAM);
  m_method_call_3(consts.str.defc_putc, consts.cl.env, socket_consts.str.sock_stream, R0);
